...
import { CrearPago, } from "app/models";
...
import { formSchemaPago } from "app/validations";
import { agregarPago } from "app/services";
import { useRouter } from "next/navigation";
import dayjs from 'dayjs';

import 'react-datepicker/dist/react-datepicker.css';
import './PagoPage.module.css';
...
export default function Home() {
  ...
  return (
    <main className="flex justify-center items-center min-h-screen bg-gray-100">
      ...
      >
        <h2 className="text-2xl font-bold mb-5">Agregar Pago</h2>
        ...
        <div className="flex justify-around mt-5 min-w-64">
          ...
          <Button
            ...
            variant="contained"
            color="primary"
            startIcon={<FaDollarSign size={20} />}
          >
            Agregar
          </Button>
        </div>
